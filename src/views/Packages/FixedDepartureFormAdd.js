...
const FixedDepartureFormAdd = ({ setcurrentStep }) => {
  const dispatch = useDispatch()
  const addPackage = useSelector((state) => state.addPackage)
  ...
  const storeUpdatePackageData = useSelector((state) => state.addPackage)
...
export default FixedDepartureFormAdd
