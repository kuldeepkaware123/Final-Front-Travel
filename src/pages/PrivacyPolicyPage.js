        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <p>
              ...
              Purulia Travels and the terms “You” /”Your” / “Yourself” refer to the users.
            </p>
            <p>
              This Privacy Policy is an electronic record in the form of an electronic contract
              formed under Informationation Technology Act, 2000 and the rules made thereunder and
            ...
            <p>
              This Privacy Policy is a legally binding document between you and Purulia
              Routes(both terms defined below). The terms of this Privacy Policy will be effective
              upon your acceptance of the same (directly or indirectly in electronic form, by
              clicking on the I accept tab or by use of the website or by other means) and will
              govern the relationship between you and Purulia Travelsfor your use of the website
              <Link to="/"> “www.PuruliaRoutes.com”</Link> (defined below).
            </p>
            <p>
              ...
              personal data or information) rules, 2011 under Information Technology Act, 2000; that
            ...
            <p>
              To avail certain services on our Websites, users are required to provide certain
            ...
            <p>
              The information as supplied by the users enables us to improve our sites and provide
            ...
            <p>
              ...
              accessible in the public domain or is furnished under the Right to Information Act,
            ...
            <p>
              ...
              similar electronic tools to collect information to assign each visitor a unique,
              random number as a User Identification (User ID) to understand the user’s individual
              interests using the Identified Computer. Unless you voluntarily identify yourself
              (through registration, for example), we will have no way of knowing who you are, even
              if we assign a cookie to your computer. The only personal information a cookie can
              ...
              advertisers may also assign their own cookies to your browser (if you click on their
              ads), a process that we do not control.
            </p>
            <p>
              Our web servers automatically collect limited information about your computer’s
              connection to the Internet, including your IP address, when you visit our site. (Your
              IP address is a number that lets computers attached to the Internet know where to send
              you data — such as the web pages you view.) Your IP address does not identify you
            ...
            <p>
              Our policy discloses the privacy practices for our own website only. Our site provides
              links to other websites that are beyond our control. We shall in no way be responsible
              in any way for your use of such sites.
            </p>

            <h3>Information Sharing</h3>
            <p>
              We share sensitive personal information with any third party without obtaining the
              prior consent of the user in the following limited circumstances:
            </p>
            <ul>
              <li>
                <strong>(a)</strong> When it is requested or required by law or by any court or
                governmental agency or authority to disclose, for the purpose of verification of
                identity, or for the prevention, detection, investigation including cyber incidents,
                or for prosecution and punishment of offenses. These disclosures are made in good
                faith and belief that such disclosure is reasonably necessary for enforcing these
                Terms; for complying with the applicable laws and regulations.
              </li>
              <li>
                <strong>(b)</strong> We propose to share such information within its group companies
                and officers and employees of such group companies for the purpose of processing
                personal information on its behalf. We also ensure that these recipients of such
                information agree to process such information based on our instructions and in
            ...
            <p>
              ...
              measures, including appropriate encryption and physical security measures to guard
              against unauthorized access to systems where we store personal data.
            </p>

            <p>
              All information gathered on our Website is securely stored within our controlled
              ...
              information you include in a posting to the discussion areas is available to anyone
              with Internet access.
            </p>

            <p>
              However, the internet is an ever-evolving medium. We may change our Privacy Policy
              from time to time to incorporate necessary future changes. Of course, our use of any
              information we gather will always be consistent with the policy under which the
              information was collected, regardless of what the new policy may be.
            </p>
            <p>
              In accordance with the Information Technology Act, 2000, if you wish to contact
              Purulia Travels about this privacy policy or privacy-related issues via email, you
              may send an email to{' '}
              <a href="mailto:info@PuruliaRoutes.com">info@PuruliaRoutes.com</a>. Alternatively,
              you may send your concern via postal mail/courier at the following address:
            </p>

            <p>
              <strong>Purulia Travels Pvt. Ltd.</strong>
              <br />
              68/346b, Hotel Shree Villas, 3rd Floor, Jagruti Marg, Jaipur, Rajasthan - 302033
              <br />
              Mobile no.: 9650129977
              <br />
              Email: <a href="mailto:info@PuruliaRoutes.com">info@PuruliaRoutes.com</a>
              <br />
              Website:{' '}
              <a href="https://www.PuruliaRoutes.com" target="_blank">
                www.PuruliaRoutes.com
              </a>
            </p>
          </div>
        </div>
