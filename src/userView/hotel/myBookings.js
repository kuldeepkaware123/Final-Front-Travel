...
function MyBookings() {
  ...
  const fetchBookings = async (token) => {
    try {
      ...
      let res = await MyAPI.GET('/user/bookings/hotel', token)
        ...
        <Table striped bordered hover responsive>
          <thead>
            <tr>
              ...
              <th className="text-dark">Hotel Name</th>
              <th className="text-dark">Booking Start Date</th>
              <th className="text-dark">Booking Date</th>
              <th className="text-dark">Total Days</th>
              <th className="text-dark">Total People</th>
